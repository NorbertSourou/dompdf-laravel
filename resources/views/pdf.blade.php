...
<div class="grid">
    <div class="contenu">
        ...
        <div style="margin-top: 40px ;" class="inline-container l ml">
            ...
            <div class="container" style="display: flex;">
                ...
                <div class="inline-container ml" style="margin-top: 10px;line-height: 5px; margin-left: 570px">
                    <span style=" font-weight: bold; font-size: 35px;  margin-left: 220px;" class="text"> TVA ( 18% ) : </span>
        ...
        <div  class="inline-container l ml" style="margin-left: 550px ;margin-top: 20px;">
            <span style=" font-weight: bold; font-size: 35px; margin-left: 180px;" class="text">Total Exo. (A-EX) : </span>
        ...
        <div class="container" style="display: flex;">
            ...
            <div class="inline-container ml" style="line-height: 5px;">
                <span style=" font-weight: bold;  font-size: 35px; margin-left: 220px;" class="text"> AIB ( 0 %) :</span>
